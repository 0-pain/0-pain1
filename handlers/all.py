...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس ", url="t.me/cen3d")],[InlineKeyboardButton("تواصل مع المطور ", url="t.me/iiwiw")],[InlineKeyboardButton("شروحات برمجية", url="t.me/Professional_school")]])
